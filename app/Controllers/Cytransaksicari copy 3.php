    ...
    public function itemPembayaran($tahun, $id_siswa, $id_lembaga, $inisial)
    {
        ...
        if ($query->getNumRows() >= 1) {
            ...
            foreach ($data['itemPembayaran'] as $row) {
                ...
                $hasil  = $hasil . '
                            <div class="row">
                                ...
                                <div class="col-sm-6 f"> 
                                    ...
                                    <input class="form-check-input" type="checkbox" id="defaultCheck'.$i.'" name="check[]"  value="checkBayar" >
                ...
                $hasil = $hasil . '<input type="hidden" name="id_transaksi[]" value="' . $row->id_transaksi . '">
                                <input type="hidden" name="nominal[]" value="' . $row->rnominal . '">
                                <input type="hidden" name="tahun[]" value="' . $row->tahun . '">
                                <input type="hidden" name="id_siswa[]" value="' . $row->id_siswa . '">
                                <input type="hidden" name="id_tagihan[]" value="' . $row->id_tagihan . '">
                                
                                <input type="hidden" name="total[]" value="' . $total . '">
                                <input type="text" name="jenis_tagihan[]" value="' . $row->jenis_tagihan . '">';
               

                if ($row->jenis_tagihan == "Cash") {
                    $hasil = $hasil . '<input type="text" name="bayar1[]" value="' . $row->rnominal . '"  class="form-control-sm col-12">';
                    ...
                    if ($row->keterangan_pembayaran == "Lunas") {
                        ...
                        $hasil  = $hasil . '<input type="number" name="bayar[]" value="0";  id="txtWeight" onchange="this.value = minmax(this.value, 0, ' . $batasMaxBayar . ')" value="' . $row->jenis_tagihan . '" onkeyup="this.value = minmax(this.value, 0, ' . $batasMaxBayar . ')" value="' . $row->jenis_tagihan . '"  class="form-control-sm col-12">';
                    }
                } else {
